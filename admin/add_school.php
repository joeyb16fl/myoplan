...
?>
	   ...
	   <div class="xs">
        ...
        <form enctype="multipart/form-data" class="form-floating ng-pristine ng-invalid ng-invalid-required ng-valid-email ng-valid-url ng-valid-pattern" novalidate="novalidate" action="reg_school.php" method="post" >
